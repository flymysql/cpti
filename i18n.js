(() => {
  ...
  STRINGS.en.common = {
    ...
    author: 'By Lanzhou Little Red Chicken',
    langZh: '中文',
    langEn: 'English',
    langSwitch: 'Language',
  };
  ...
  STRINGS.zh.shareCard = {
    ...
    footerSelf: '长按保存「记忆卡」· 记录你的恋语瞬间（仅供娱乐）',
    footerMatch: '长按保存「羁绊记忆卡」· 适合与 Ta 一起收藏（仅供娱乐）',
    banner: '限定记忆 · CPTI',
    portraitSelf: '卡面立绘',
    portraitMatch: '羁绊立绘',
    statFavor: '好感度',
  ...
  STRINGS.en.shareCard = {
    ...
    footerSelf: 'Long-press to save this memory card (for fun only)',
    footerMatch: 'Long-press to save this bond card (for fun only)',
    banner: 'Limited memory · CPTI',
    ...
    footerBrand: 'Love lab · memory card',
